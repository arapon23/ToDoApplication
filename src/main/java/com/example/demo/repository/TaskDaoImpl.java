...
public class TaskDaoImpl implements TaskDao {
	...
	public List<Task> findAll() {
		...
		//return用の空のListを用意
		List<Task> list = new ArrayList<Task>();  //リターン用の空リストを作成
	...
	@Override  // nullが戻り値となる事を懸念して、Optionalとしてある
	public Optional<Task> findById(int id) {
		...
		//タスクを一件取得
		Map<String, Object> result = jdbcTemplate.queryForMap(sql, id);  // これでSQLインジェクションを防ぐ
